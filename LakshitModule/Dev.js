...
import { View, Text, Image, StyleSheet, TextInput, Pressable,SafeAreaView, Keyboard, ActivityIndicator } from 'react-native';
  ...
  return (
    ...
    >
      ...
      <View style={styles.formContainer}>
        <Text style={styles.text}>Your #1 Vocabulary Learning Companion !</Text>
        ...
        {!validateMobileNumber(contact) && (
          <Text style={styles.errorMessage}>Mobile number must be 10 digits</Text>
        )}
        <Pressable
